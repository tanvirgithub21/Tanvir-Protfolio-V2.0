    ...
    <section className="container">
      <div className="homeWrap flex justify-center items-center mt-16">
        ...
        <div className="flex flex-1 justify-end items-center">
          <div className="imgBox w-[21rem] h-[21rem] bg-slate-200 rounded-full overflow-hidden my-10 mr-20">
        ...
        <div className="flex-1">
          ...
          <div className=" max-w-[70%]">
            <h2 className="text-xl sm:text-3xl md:text-4xl  font-semibold">Tanvir Ahmed</h2>
            <h4 className="text-base sm:text-lg text-slate-600 my-3">Web Devloper</h4>
            <p>
